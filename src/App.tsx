          ...
          onTrackView={async () => {
            try {
              await fetch("/api/popup/track", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({ type: "view", popupTitle: dbStats?.videoPopup?.titleEs, studentEmail: loggedStudent?.email, annId: dbStats?.videoPopup?.annId })
              });
            } catch (e) {}
          }}
          onTrackClick={async () => {
            try {
              await fetch("/api/popup/track", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({ type: "click", popupTitle: dbStats?.videoPopup?.titleEs, studentEmail: loggedStudent?.email, annId: dbStats?.videoPopup?.annId })
              });
            } catch (e) {}
          }}
        />
