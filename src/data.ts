...
export const LEVEL_TOPICS: Record<string, string[]> = {
  A1: [
    ...
    "Numbers 1 to 100 & Telling Time",
    "Family Members & Relationships",
    "Noun Gender & Articles",
    "SER vs ESTAR — To Be",
    "Regular -AR Verbs: Hablar, Estudiar",
    "Daily Activities & Routines",
    "Ordering Food & Cafe Vocabulary",
    "Weather & Seasons",
    "Colors & Clothing",
    "Describing Places & Directions",
    "My Academic Goals & University Life",
    "GUSTAR & Preference Verbs"
  ],
  A2: [
    "Preterite Tense: Regular Verbs",
    "Preterite Tense: Irregular Verbs",
    "Imperfect Tense: Uses & Formation",
    "Reflexive Verbs & Daily Routines",
    "Object Pronouns: Direct & Indirect",
    "Talking about Childhood Memories",
    "Shopping & Prices in Spain",
    "Accommodation & Rental Vocabulary",
    "Asking for Medical Help",
    "Public Transport & Getting Around",
    "Making Plans with IR + A + Infinitive",
    "Comparatives & Superlatives",
    "Spanish Regions & Cities",
    "My Academic Background",
    "Future Plans & Post-Graduation Goals"
  ],
  B1: [
    "Introduction to Subjunctive Mood",
    "Expressing Doubts & Recommendations",
    "Por vs Para — Key Differences",
    "Conditional Tense: Would & Could",
    "Writing a Motivation Letter in Spanish",
    "CV Writing & Job Applications",
    "Talking about Social Problems",
    "Spanish Cinema & Cultural Icons",
    "Renting Shared Flats & Legal Rights",
    "Preparing for DELE B1 Oral Exam",
    "Formal Email Writing",
    "Spanish Idiomatic Expressions",
    "Comparing Regional Accents & Slang",
    "Academic Research & References",
    "Visa & Enrollment Interview Vocabulary"
  ],
  B2: [
    "Advanced Subjunctive & Conditionals",
    "Writing Academic Essays in Spanish",
    "Spanish Media & Press Analysis",
    "Advanced Pronoun Placement",
    "Professional Interviews & Internships",
    ...
    "Spanish Economy & Business Culture",
    "University Student Unions & Rights",
    "Advanced Listening: Podcasts & News",
    "Collocations & Fixed Expressions",
    "DELE B2 Writing & Speaking Tasks"
  ],
  C1: [
    "Socio-Political Analysis of Spain",
    "Advanced Technical Writing",
    "Subtle Idiomatic Nuances",
    "Defending a Dissertation in Spanish",
    "Legal Terminology & Bureaucracy",
    "Public Administration & Oposiciones",
    "Journalistic Writing & Editing",
    "Interpreting Regional Dialects",
    "Syntactic Precision & Absolutes",
    "Advanced Rhetoric & Argumentation"
  ],
  C2: [
    "Philosophical Discourse & Writing",
    "Metaphorical Expression in Poetry",
    "Archaisms & Legalistic Language",
    "Simultaneous Interpretation Skills",
    "Phonetic Convergence & Native Speech",
    "Writing Research Papers in Spanish",
    "Cultural Semiotics & Spanish Folklore",
    "Advanced Stylistics & Editorial Writing",
    "Linguistic Authority & Academic Lexicon",
    "DELE C2 Full Preparation Masterclass"
  ]
};
